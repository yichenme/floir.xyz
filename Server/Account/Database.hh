...
namespace AccountDB {
    ...
    int read_talents(std::string const &user, uint8_t &health_rank, uint8_t &reload_rank);
    int write_talents(std::string const &user, uint8_t health_rank, uint8_t reload_rank);
